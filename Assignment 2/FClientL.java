/* Receive demoText.html file contents from server upon sending request with Lost Frame and Lost Acknowledgement */

import java.net.*;
import java.io.*;
import java.util.*;

public class FClientL {
